...
Youtube Broken Link Checker hide all broken links youtube videos to improve SEO.

Youtube Broken Link Checker monitors and checks all internal and external Youtube links on your website that are broken or unreachable. Hide or replace all YouTube video links by restoring them to improve SEO and user experience.
...
1. Download 'youtube-broken-link-checker.zip'
2. Unzip
...
5. Go to *Settings > youtube-broken-link-checker to configure the plugin.

== Screenshots ==
1. Youtube Broken Link checker No video available
