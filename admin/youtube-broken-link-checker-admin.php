    ...
    class YoutubeBrokenLinkChecker {
        ...
        public function youtube_broken_link_checker_create_admin_page() {
            ...
            <div class="wrap">
                ...
                <p><?php esc_html__('Youtube Broken Link Checker monitors and checks all internal and external links on your site for broken youtube links. Hide all broken links youtube videos to improve SEO and user experience', 'youtube-broken-link-checker'); ?>.</p>
                <?php settings_errors(); ?>
				<table>
					<tr>
						<td>
						...
						<td>
							<?php if(!wp_is_mobile()) { ?>
								<img src="<?php echo esc_url(plugin_dir_url( __FILE__ ) . 'assets/screenshot-1-desktop-device.png'); ?>" alt="screenshot desktop and mobile device" />
							<?php } else { ?>
        ...
        public function google_youtube_api_key_0_callback() {
            printf(
                '<input class="regular-text" type="text" name="youtube_broken_link_checker_option_name[google_youtube_api_key_0]" id="google_youtube_api_key_0" value="%s"> <label for="google_youtube_api_key_0"><a target="_blank" alt="How to Get YouTube Data API Key" href="https://developers.google.com/youtube/v3/getting-started">'.esc_html__('How to Get YouTube Data API Key','youtube-broken-link-checker').'How to Get YouTube Data API Key</a></label>',
