            ...
            <div class="wrap">
				...
				<table>
					<tr>
						...
						<td>
							<?php if(!wp_is_mobile()) { ?>
								<img src="<?php echo esc_url(plugin_dir_url( __FILE__ ) . 'assets/screenshot-1.png'); ?>" alt="screenshot desktop and mobile device" />
							<?php } else { ?>
								<img src="<?php echo esc_url(plugin_dir_url( __FILE__ ) . 'assets/screenshot-1.png'); ?>" alt="screenshot only mobile device" />
							<?php } ?>
						</td>
					</tr>	
				</table>	
